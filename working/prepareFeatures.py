...
def extractImages(options_data): #options_data is either "faces" or "digit"
    options_training = 450
    options_test = 100
...
def runNBFace():
    trainingData,trainingLabels,testData,testLabels=extractImages("faces")
...
def runPerceptronDigit():
    trainingData,trainingLabels,testData,testLabels=extractImages("digit")
...
def runkNNFace():
    ...
    trainFeatures = list(map(featureFunction, trainingData))
    testFeatures = list(map(featureFunction,testData))
    predict=kNN.predict(trainFeatures,trainingLabels,testFeatures,testLabels,3)
    print(percentCorrect(testLabels,predict))
